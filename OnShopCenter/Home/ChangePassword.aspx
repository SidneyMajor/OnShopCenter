<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="OnShopCenter.Home.ChangePassword" %>
                    ...
                    <div class="login100-form validate-form">
                        <div class="container-login100-form-btn m-t-32">
                            ...
                            <span class="login100-form-title p-b-59">
                                <asp:Label ID="lbl_mg" runat="server" Text=""></asp:Label><br />
                            </span>

                            <span class="login100-form-title p-b-59">Change Password<br />
                            </span>

                            <div class="wrap-input100 validate-input" data-validate="Old Password is required">
                                <span class="label-input100">Old Password</span>
                                <input class="input101" type="password" name="pass" placeholder="*************" id="old_password" runat="server" />
